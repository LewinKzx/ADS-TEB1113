...
int main() {
    ...
    list.insertFront("Muaz");
    cout << "\nAfter insertFront (Muaz):" << endl;
    list.display();

    list.insertEnd("Lewin");
    cout << "\nAfter insertEnd (Lewin):" << endl;
    list.display();
    ...
    list.insertBefore("Ahmad", "Abu");
    cout << "\nAfter insertBefore (Abu before Ahmad):" << endl;
    list.display();
